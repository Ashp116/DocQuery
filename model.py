...
class DocVLM(nn.Module):
    def __init__(self, qwen_model, encoder):
        super().__init__()
        self.qwen = self.qwen_model
        self.encoder = encoder


    def forward(self, ocr_inputs_ids, ocr_attention_mask, bbox, input_ids, attention_mask, labels=None, pixel_values=None, image_grid_thw=None):
